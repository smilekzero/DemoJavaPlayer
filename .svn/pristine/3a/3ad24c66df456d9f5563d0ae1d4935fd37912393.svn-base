            ...
            <div class="tab-content flex-grow-1" id="v-pills-tabContent">
                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                    ...
                    <ul class="sidebar-menu">
                        <li class="treeview">
                            <a href="index.html">
                            <i class="icon icon-sailing-boat-water s-24"></i> <span>@yield('title','Dashboard')</span>
                            </a>
                        </li>
                        ...
                        <li class="treeview"><a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="inbox.html"><i class="icon icon-circle-o"></i>所有音乐</a>
                                <li><a href="/admin/music/create"><i class="icon icon-add"></i>上传音乐</a>
                                </li>
                        ...
                        <!-- MV管理模块开始 -->
                        <li class="treeview"><a href="#">
                            <i class="icon icon-video_library s-24"></i>
                            <i class=" icon-angle-left  pull-right"></i>
                            <strong>MV管理</strong>
                        </a>
                            <ul class="treeview-menu">
                                <li><a href="inbox.html"><i class="icon icon-circle-o"></i>所有MV</a>
                                <li><a href="admin/video/create"><i class="icon icon-add"></i>上传MV</a>
                                </li>
                                <li><a href="inbox-create.html"><i class="icon icon-add"></i>Compose</a>
                                </li>
                            </ul>
                        ...
                        <div class="p-2">
                            <ul class="list-unstyled">
                                ...
                                <li class="pt-3 pb-3 sticky p-3 b-b white">
                                    ...
                                    <a style="float: right;" class="btn btn-primary btn-sm" href="/admin/singer/create">添加歌手</a>
                                </li>
                                <!-- 歌手信息 -->
                                <li class="my-1">
            ...
            <div class="relative">
                <div class="d-flex">
                    <div class="d-none d-md-block">
                        <h1 class="nav-title">@yield('submenu','Dashboard')</h1>
                    </div>
                </div>
            </div>
            <!--Top Menu Start -->
