...
<body class="">
    ...
    <header class="bg-white-only header header-md navbar navbar-fixed-top-xs">
      <div class="navbar-header aside bg-primary nav-xs">
        ...
        <a href="" class="navbar-brand text-lt">
          ...
          <img src="{{URL::asset('images/home/logo.png')}}" alt="." class="hide">
                ...
                <div class="list-group list-group-alt">
                  <a href="#" class="media list-group-item">
                    <span class="pull-left thumb-sm">
                      <img src="{{URL::asset('images/home/a0.png')}}" alt="..." class="img-circle">
                    </span>
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle bg clear" data-toggle="dropdown">
              <span class="thumb-sm avatar pull-right m-t-n-sm m-b-n-sm m-l-sm">
                <img src="{{URL::asset('images/home/a0.png')}}" alt="...">
              </span>
                  ...
                  <div class="dropdown dropup wrapper-sm clearfix">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <span class="thumb-sm avatar pull-left m-l-xs">
                        <img src="{{URL::asset('images/home/a3.png')}}" class="dker" alt="...">
  ...
  <script src="js/home/masonry/tiles.min.js"></script>
  <script src="js/home/masonry/demo.js"></script>
