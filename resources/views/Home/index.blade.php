            ...
            <section>
              <section class="vbox">
                <section class="scrollable padder-lg w-f-md" id="bjax-target">
                  ...
                  <h2 class="font-thin m-b">推荐新歌 <span class="musicbar animate inline m-l-sm" style="width:20px;height:20px">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                      <div class="item">
                        <div class="pos-rlt">
                          ...
                          <!-- 鼠标滑动完 -->
                          <a href="#"><img src="{{URL::asset('images/home/p1.jpg')}}" alt="" class="r r-2x img-full"></a>
                        </div>
                        <div class="padder-v">
                          <a href="#" class="text-ellipsis">{{$v['mname']}}</a>
                          <a href="#" class="text-ellipsis text-xs text-muted">仓央嘉措</a>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="{{URL::asset('images/home/a2.png')}}" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="{{URL::asset('images/home/a3.png')}}" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="{{URL::asset('images/home/a8.png')}}" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="{{URL::asset('images/home/a9.png')}}" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="{{URL::asset('images/home/a1.png')}}" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="{{URL::asset('images/home/a6.png')}}" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="{{URL::asset('images/home/a7.png')}}" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                        ...
                        <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="{{URL::asset('images/home/a5.png')}}" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                  ...
                  <ul class="list-group no-bg no-borders auto m-t-n-xxs">
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="{{URL::asset('images/home/a1.png')}}" alt="..." class="img-circle">
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="{{URL::asset('images/home/a5.png')}}" alt="..." class="img-circle">
                        <i class="on b-light right sm"></i>
                      </span>
                      <div class="clear">
                        <div><a href="#">Chris Fox</a></div>
                    ...
                    <li class="list-group-item">
                      <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                        <img src="{{URL::asset('images/home/a9.png')}}" alt="..." class="img-circle">
                        <i class="on b-light right sm"></i>
                      </span>
                      <div class="clear">
                        <div><a href="#">Chris Fox</a></div>
